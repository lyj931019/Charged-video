    ...
    <section data-swiftype-index="false" id="footer">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-5 offset-md-1 col-sm-6 pull-right">
              <!--<div class="lead-collection-form" id="lead-collection-form">-->
              <!--<div class="form-header">-->
              <!--<div class="lead-form-global">-->
              ...
              <!--</div>-->
              <!--<div class="lead-form-coming-soon">-->
              <!--<h3>Stay Informed About This Course</h3>-->
              <!--<p>Create an account to download our free course catalog, and receive updates about this course.</p>-->
              <!--</div>-->
              <!--<div class="lead-form-graduate-checklist">-->
              <!--<h3>You'll also get access to our course catalog, degree and lesson handbooks, sample lessons, and more.</h3>-->
              <!--</div>-->
              <!--<div class="lead-form-sample-lesson">-->
              <!--<h3>Sign Up to Sample a Lesson</h3>-->
              <!--</div>-->
              <!--</div>-->
              ...
              <!--<h6>-->
              <!--<i>-->
              <!--<svg class="svg-inline&#45;&#45;fa fa-lock fa-w-14" aria-hidden="true" data-prefix="fa" data-icon="lock" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M400 224h-24v-72C376 68.2 307.8 0 224 0S72 68.2 72 152v72H48c-26.5 0-48 21.5-48 48v192c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V272c0-26.5-21.5-48-48-48zm-104 0H152v-72c0-39.7 32.3-72 72-72s72 32.3 72 72v72z"></path></svg>&lt;!&ndash; <div class="fa fa-icon fa-lock"></div> &ndash;&gt;-->
              <!--</i>-->
              <!--<span>-->
              <!--&nbsp; Secure form. Berklee Online will not sell or rent your email address to third parties.<br><a href="/about/privacy">Our privacy policy</a>-->
              <!--</span>-->
              <!--</h6>-->
              <!--</div>-->
              <!--</div>-->
      ...
      <footer class="main-footer no-gutter" id="info-footer">
        <div class="row no-gutters">
          ...
          <div class="col-12 col-sm-12 col-lg-5 offset-lg-1" style="background: #25353C;">
            <div class="footer-block-inner">
              <h4>
                All Programs
              </h4>
              ...
              <ul>
                ...
                <li><a href="#" target="_blank">Read Take Note Magazine</a></li>
              </ul>
      ...
      <div class="footer-bottom no-gutter">
        <div class="row">
          <div class="col-12">
            <img alt="UPCEA Winner 2005 - 2017" src="../assets/img/footer_award_upcea.svg">
            <img alt="Berklee College of Music Logo" class="bo-logo" src="../assets/img/footer_logo.svg">
            <img alt="QS Reimagine Education Award 2016" src="../assets/img/footer_award_QS_Stars.svg">
          </div>
        </div>
        <div class="row">
          <div class="col-12">
...
<style scoped>
  .home_page section#footer, .home_page section.footer-form {
    margin-bottom: 0;
  }
  ...
  .main-footer h4:not(:first-child) {
    margin-top: 30px;
  }
  .main-footer ul {
    padding-left: 0px;
